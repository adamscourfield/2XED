...
async function main() {
  ...
  const skillDefs = [
    ...
    { code: 'N1.21', name: 'Extended number-line reasoning (scaled intervals and estimation)',                       strand: 'PV',  isStretch: true,  sortOrder: 171 },
    { code: 'N1.22', name: 'Directed numbers in context using linear scales',                                        strand: 'PV',  isStretch: true,  sortOrder: 172 },
    { code: 'N1.23', name: 'Multi-step comparison and ordering across representations',                               strand: 'PV',  isStretch: true,  sortOrder: 173 },
    { code: 'N1.24', name: 'Synthesis: integers, decimals, negatives, and powers of ten on a line',                   strand: 'PV',  isStretch: true,  sortOrder: 174 },

...
async function main() {
  const mappingPath = path.resolve(process.cwd(), 'docs/unit-mapping/review-pack-unit1-partA-foundation-n14.jsonl');
  ...
  console.log(`✅ Unit1 n14 import complete. Created: ${created}, Updated: ${updated}, Total lines: ${lines.length}`);
}

...
import {
  ...
  type TimetableSlotForExpansion,
} from '@/features/timetable/expandTimetableSlots';
...
function studentPracticeHref() {
  return '/student/live?mode=practice';
}
  ...
  if (role === 'STUDENT') {
    ...
    for (const r of classReviews) {
      events.push({
        ...
        kind: 'class_review',
        title: r.skill.name,
        href: '/teacher/dashboard/classes/analytics',
